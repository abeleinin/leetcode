...
|--------------------|---------|------------|---
| :heavy_check_mark: | [Contains Duplicate](https://leetcode.com/problems/contains-duplicate) | Easy | [python3](./easy/217-Contains-Duplicate.py) [cpp](./easy/cpp/217-Contains-Duplicate.cpp)
| :heavy_check_mark: | [Valid Anagram](https://leetcode.com/problems/valid-anagram) | Easy | [python3](./easy/242-Valid-Anagram.py) [cpp](./easy/cpp/242-Valid-Anagram.cpp)
...
| :heavy_check_mark: | [Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements/) | Medium | [python3](./medium/347-Top-K-Frequent-Elements.py) [cpp](./medium/cpp/347-Top-K-Frequent-Elements.pp)
...
| :heavy_check_mark: | [Valid Sudoku](https://leetcode.com/problems/valid-sudoku/) | Medium | [python3](./medium/36-Valid-Sudoku.py) [cpp](./medium/cpp/36-Valid-Sudoku.cpp)
...
| :heavy_check_mark: | [3Sum](https://leetcode.com/problems/3sum/) | Medium | [python3](./medium/15-3Sum.py) [cpp](./medium/cpp/15-3Sum.cpp)
...
| :heavy_check_mark: | [Longest Repeating Character Replacement](https://leetcode.com/problems/longest-repeating-character-replacement/) | Medium | [python3](./medium/424-Longest-Repeating-Character-Replacement.py) [cpp](./medium/cpp/424-Longest-Repeating-Character-Replacement.cpp)
...
| Status             |Problem  | Difficulty | Code
|--------------------|---------|------------|-----
| :heavy_check_mark: | [Valid Parentheses](https://leetcode.com/problems/valid-parentheses) | Easy | [python3](./easy/20-Valid-Parentheses.py) [cpp](./easy/cpp/20-Valid-Parentheses.cpp)
| :heavy_check_mark: | [Min Stack](https://leetcode.com/problems/min-stack) | Medium | [python3](./medium/155-Min-Stack.py) [cpp](./medium/cpp/155-Min-Stack.cpp)
...
| :heavy_check_mark: | [Daily Temperatures](https://leetcode.com/problems/daily-temperatures/) | Medium | [python3](./medium/739-Daily-Temperatures.py) [cpp](./medium/cpp/739-Daily-Temperatures.cpp)
| :heavy_check_mark: | [Car Fleet](https://leetcode.com/problems/car-fleet/) | Medium | [python3](./medium/853-Car-Fleet.py) [cpp](./medium/cpp/853-Car-Fleet.cpp)
...
| :heavy_check_mark: | [Reorder List](https://leetcode.com/problems/reorder-list/) | Medium | [python3](./medium/143-Reorder-List.py) [cpp](./medium/cpp/143-Reorder-List.cpp)
...
| :heavy_check_mark: | [Copy List with Random Pointer](https://leetcode.com/problems/copy-list-with-random-pointer/) | Medium | [python3](./medium/138-Copy-List-with-Random-Pointer.py)
...
| Status             |Problem  | Difficulty | Code
|--------------------|---------|------------|-----
| :heavy_check_mark: | [Invert Binary Tree](https://leetcode.com/problems/invert-binary-tree) | Easy | [python3](./easy/226-Invert-Binary-Tree.py) [cpp](./easy/cpp/226-Invert-Binary-Tree.cpp)
| :heavy_check_mark: | [Maximum Depth of Binary Tree](https://leetcode.com/problems/maximum-depth-of-binary-tree) | Easy | [python3](./easy/104-Maximum-Depth-of-Binary-Tree.py) [cpp](./easy/c/cpp/104-Maximum-Depth-of-Binary-Tree.cpp)
| :heavy_check_mark: | [Diameter of Binary Tree](https://leetcode.com/problems/diameter-of-binary-tree) | Easy | [python3](./easy/543-Diameter-of-Binary-Tree.py) [cpp](./easy/cpp/543-Diameter-of-Binary-Tree.cpp)
...
| :heavy_check_mark: | [Count Good Nodes in Binary Tree](https://leetcode.com/problems/count-good-nodes-in-binary-tree/) | Medium | [python3](./medium/1448-Count-Good-Nodes-in-Binary-Tree.py)
...
| Status             |Problem  | Difficulty | Code
|--------------------|---------|------------|-----
| :heavy_check_mark: | [Unique Paths](https://leetcode.com/problems/unique-paths) | Medium | [python3](./medium/62-Unique-Paths.py) 

### Greedy
| Status             |Problem  | Difficulty | Code
|--------------------|---------|------------|-----
| :heavy_check_mark: | [Maximum Subarray](https://leetcode.com/problems/maximum-subarray) | Medium | [python3](./medium/52-Maximum-Subarray.py) [cpp](./medium/cpp/52-Maximum-Subarray.cpp)
| :heavy_check_mark: | [Jump Game](https://leetcode.com/problems/jump-game) | Medium | [python3](./medium/55-Jump-Game.py) 
| :heavy_check_mark: | [Jump Game II](https://leetcode.com/problems/jump-game-ii) | Medium | [python3](./medium/45-Jump-Game-II.py) 
...
| Status             |Problem  | Difficulty | Code
|--------------------|---------|------------|-----
| :heavy_check_mark: | [Rotate Image](https://leetcode.com/problems/rotate-image/) | Medium | [python3](./medium/48-Rotate-Image.py) [cpp](./medium/cpp/48-Rotate-Image.cpp)
| :white_large_square: | Happy Number | Easy 
| :white_large_square: | Plus One | Easy 
| :heavy_check_mark: | [Set Matrix Zeros](https://leetcode.com/problems/set-matrix-zeroes/) | Medium | [python3](./medium/73-Set-Matrix-Zeros.py)

### Bit Manipulation
| Status             |Problem  | Difficulty | Code
|--------------------|---------|------------|-----
| :heavy_check_mark: | [Single Number](https://leetcode.com/problems/single-number/) | Easy | [python3](./easy/136-Single-Number.py) [cpp](./easy/cpp/136-Single-Number.cpp)
| :heavy_check_mark: | [Number of 1 Bits](https://leetcode.com/problems/number-of-1-bits/) | Easy | [python3](./easy/191-Number-of-1-Bits.py)
| :heavy_check_mark: | [Counting Bits](https://leetcode.com/problems/counting-bits/) | Easy | [python3](./easy/338-Counting-Bits.py)
